  ...
  <> 
    <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 text-left">
     ...
     <div className="max-w-xl z-10 text-gray-600">
      <h1 className="md:text-course-details-heading  text-course-details-heading-large text-course-details-heading-small font-semibold text-gray-800">{courseData.courseTitle}</h1>
      <p className="pt-3 md:text-base text-sm"
       ...
       {/* Review */}
         <div className='flex items-center space-x-2  pt-3 pb-1 text-sm'>
               ...
               <p className="text-sm">Course by <span className="text-blue-600 underline ">NexLearn</span></p>
               <div className="pt-8 text-gray-800">
                <h2 className="text-xl font-semibold">Course Structure</h2>
              <div className="pt-5 ">
                {courseData.courseContent.map((chapter,index)=>
                  (
                    <div className="border border-gray-300 bg-white mb-2 rounded-2xl" key={index}>
               ...
               <div className="py-20 text-sm md:text-default">
                <h3 className="text-xl font-semiboldtext-gray-800">Course Description</h3>
     ...
     <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420ox] ">
              {
          playerData ? 
      ...
      <div className="flex items-center text-sm md:text-default  gap-4 pt-2 md:pt-4 text-gray-500">
          ...
          <div className="pt-6">
            ...
            <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-blue-700" >
