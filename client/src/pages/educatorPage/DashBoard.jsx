    ...
    <div className='min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 md:pb-0 pt-8 pb-0'>
      <div className='space-y-5'>
        ...
        <div className='flex flex-wrap gap-5'>
          ...
          <div className='flex items-center gap-3 shadow-card border border-r-blue-500 p-4 w-56 rounded-md'>
            ...
            <tbody className='text-sm text-gray-500'>
              {dashboardData.enrolledStudentsData.map((item,index)=>(
                <tr key={index} className=' border-gray-500/20 border-b '>
                  <td className='py-3 px-4 text-center hidden sm:table-cell'> {index + 1} </td>
